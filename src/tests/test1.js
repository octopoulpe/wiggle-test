...
App1.prototype.fillArray = function (indices, points, payload) {
...
App1.prototype.bindEvent = function () {
...
App1.prototype.teardown = function () {
    this.stop = true;
    this.texture.free();
...
App1.prototype.step = function (timestamp) {
    if (this.stop) {
        return;
    }
